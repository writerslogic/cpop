...
This specification defines the high-integrity hardening measures implemented in `witnessd` to protect cryptographic material and evidence capture logic against a **white-box adversary** (a local user with root privileges and debugging tools).
