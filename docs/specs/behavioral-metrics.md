...
This specification defines the behavioral forensic metrics used by WritersLogic to analyze edit patterns for consistency with human authorship. These metrics examine the spatial distribution and timing of document edits without capturing actual content.
...
| Term | Definition |
|------|------------|
| **Event** | A file modification detected by WritersLogic |
...
1. **Indirect Measurement:** WritersLogic observes file save events, not actual
