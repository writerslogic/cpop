...
```bash
slsa-verifier verify-artifact cpop_jitter-<version>.crate \
  --provenance-path multiple.intoto.jsonl \
  --source-uri github.com/LF-Decentralized-Trust-labs/proof-of-process \
...
- [GitHub Releases](https://github.com/LF-Decentralized-Trust-labs/proof-of-process/releases)
- [crates.io](https://crates.io/crates/cpop_jitter)
- [Documentation](https://docs.rs/cpop_jitter)

[Unreleased]: https://github.com/LF-Decentralized-Trust-labs/proof-of-process/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/LF-Decentralized-Trust-labs/proof-of-process/releases/tag/v0.2.0
