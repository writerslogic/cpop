...
mod tests {
    ...
    fn test_mmr_error_variants() {
        ...
        let cases: Vec<(MmrError, &str)> = vec![
            (MmrError::Empty, "mmr: empty"),
            (MmrError::CorruptedStore, "mmr: corrupted store"),
            (MmrError::IndexOutOfRange, "mmr: index out of range"),
            (MmrError::InvalidNodeData, "mmr: invalid node data"),
            (MmrError::InvalidProof, "mmr: invalid proof"),
            (MmrError::HashMismatch, "mmr: hash mismatch"),
            (MmrError::NodeNotFound, "mmr: node not found"),
            (
                MmrError::ProofTooLarge,
                "mmr: proof component exceeds u16::MAX elements",
            ),
        ];
