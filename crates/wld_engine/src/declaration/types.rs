...
/// Content input method classification.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Named participant who contributed to the document.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Role a collaborator played in the document.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Compact summary of a declaration for display purposes.
#[derive(Debug, Clone, Serialize, Deserialize)]
