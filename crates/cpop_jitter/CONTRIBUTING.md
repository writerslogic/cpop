# Contributing to cpop_jitter

Thank you for your interest in contributing to cpop_jitter! This document provides guidelines and instructions for contributing to this cryptographic library.
...
cd writerslogic/crates/cpop_jitter
...
- **Questions**: Open a [discussion](https://github.com/writerslogic/writerslogic/discussions)
- **Bugs**: Open an [issue](https://github.com/writerslogic/writerslogic/issues)
- **Security**: See [SECURITY.md](SECURITY.md)

---

Thank you for contributing to cpop_jitter!
