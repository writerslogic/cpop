<p align="center">
  <strong>witnessd_engine</strong><br>
...
**witnessd_engine** is the cryptographic core library that produces independently verifiable, tamper-evident process evidence constraining when and how a document could have been created.
...
| **[witnessd_cli](https://github.com/writerslogic/witnessd_cli)** | Command-line interface + Linux packaging (GPL-3.0) |
