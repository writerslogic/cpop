...
use ed25519_dalek::{Signature, Signer as _, VerifyingKey, Verifier as _};
...
pub struct Block {
    ...
    ///
    /// When present, this nonce was incorporated into the packet signature
    /// to prove the evidence was generated in response to a specific
...
pub struct ForensicDetails {
    ...
    /// Whether a verifier nonce is present (for replay attack prevention)
...
impl Block {
    ...
    pub fn sign(&mut self, signer: &dyn PoPSigner) -> Result<(), String> {
        // Sign H3
        let signature_bytes = signer.sign(&self.seal.h3)
    ...
    pub fn encode_ascii(&self) -> String {
        ...
        // Include verifier nonce in header when present
