...
fn test_mouse_idle_stats_in_activity_fingerprint() {
    use witnessd_engine::fingerprint::ActivityFingerprint;
...
fn test_rfc_time_binding_tier_calculation() {
    use witnessd_engine::rfc::TimeBindingTier;
...
fn test_error_topology_analysis() {
    use witnessd_engine::analysis::{analyze_error_topology, EventType, TopologyEvent};
...
fn test_galton_invariant_perturbation_response() {
    use witnessd_engine::analysis::ProbeSample;
