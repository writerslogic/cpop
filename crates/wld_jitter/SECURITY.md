...
[![Security](https://github.com/writerslogic/writerslogic/actions/workflows/security.yml/badge.svg)](https://github.com/writerslogic/writerslogic/actions/workflows/security.yml)
[![SLSA 3](https://slsa.dev/images/gh-badge-level3.svg)](https://slsa.dev)

This document outlines the security policy for the `wld_jitter` crate, including vulnerability reporting, threat model, security considerations, and secure usage guidelines.
...
1. **GitHub Security Advisories** (Preferred)
   - Navigate to the [Security tab](https://github.com/writerslogic/writerslogic/security/advisories)
...
`wld_jitter` is designed to provide proof-of-process through timing jitter. It is **NOT**:
...
```rust
use wld_jitter::{HybridEngine, Session};
...
curl -LO https://github.com/writerslogic/writerslogic/releases/download/v0.2.0/wld_jitter-0.2.0.crate
curl -LO https://github.com/writerslogic/writerslogic/releases/download/v0.2.0/multiple.intoto.jsonl

# Verify
slsa-verifier verify-artifact wld_jitter-0.2.0.crate \
...
- **GitHub Security Advisories**: [Report here](https://github.com/writerslogic/writerslogic/security/advisories)
- **General questions**: [GitHub Discussions](https://github.com/writerslogic/writerslogic/discussions)
