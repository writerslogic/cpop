...
```toml
[dependencies]
cpop_protocol = { git = "https://github.com/writerslogic/writerslogic", branch = "main" }
```

## Related Projects

- [WritersLogic](https://github.com/writerslogic/writerslogic): Monorepo containing all WritersLogic components.
- [cpop_jitter](../cpop_jitter): Hardware entropy collection primitive for PoP.
- [cpop_engine](../cpop_engine): High-performance cryptographic engine.
