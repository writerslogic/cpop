...
impl TimeBindingTier {
    ...
    pub fn compute(
        ...
        if blockchain_count >= 2 && tsa_count >= 2 {
            ...
            // Roughtime alone requires 2+ servers for Byzantine fault tolerance;
            // a single Roughtime response is treated as Standard (with VDF).
            Self::Enhanced
