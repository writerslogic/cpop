...
impl HashValue {
    ...
    ///
    /// # Panics
    /// If `digest` is not 32 bytes. Use [`try_sha256`](Self::try_sha256) for fallible construction.
    ...
    ///
    /// # Panics
    /// If `digest` is not 48 bytes. Use [`try_sha384`](Self::try_sha384) for fallible construction.
    ...
    ///
    /// # Panics
    /// If `digest` is not 64 bytes. Use [`try_sha512`](Self::try_sha512) for fallible construction.
