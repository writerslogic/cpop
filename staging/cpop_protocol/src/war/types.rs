...
/// A WAR block (protocol-level).
///
/// This contains the wire-format fields shared across engine and protocol.
// NOTE: Engine-level Block extends this with evidence: Option<Box<Packet>>
