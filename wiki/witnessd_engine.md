...
**witnessd_engine** is the high-performance cryptographic engine at the heart of the witnessd ecosystem. It produces independently verifiable, tamper-evident process evidence constraining when and how a document could have been created.

**License:** Apache-2.0
**Path:** [`crates/witnessd_engine`](https://github.com/writerslogic/witnessd/tree/main/crates/witnessd_engine)
...
- **[[witnessd_protocol]]**: Wire format types and forensic models
- **[[witnessd_jitter]]** (optional): Hardware timing entropy
