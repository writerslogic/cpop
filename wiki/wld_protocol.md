...
**wld_protocol** is the core Rust implementation of the **[[Glossary#PoP|Proof-of-Process (PoP)]]** protocol wire format, currently being socialized in the **[[Glossary#RATS|IETF RATS]]** working group.

**License:** Apache-2.0
**Path:** [`crates/wld_protocol`](https://github.com/writerslogic/writerslogic/tree/main/crates/wld_protocol)
...
- **[[wld_jitter]]**: Hardware timing entropy for jitter seals
