...
This document details the high-integrity hardening measures implemented in **CPoE** to protect cryptographic material and evidence capture logic against a **white-box adversary** (a local user with root privileges and debugging tools). These measures constitute the **Tier 4** security profile of the system.
